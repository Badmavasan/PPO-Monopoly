...
public class CaseTest {
	...
	@Test
	public void caseLoiAntitrustTest() throws PlateauCreationFailedException, JoueurListCreationFailedException, JoueurNotFoundException, CaseDoesNotExistEtatInvestissement, PlayerInvestissementException {
		/*--------------------------- INITIALISATION -------------------------------------- */
